...
public enum UI_Room_Creation_View
{
    tint,
    container,
    container_2,
...
internal static class UI_Room_Creation_View_Map
{
    internal static readonly Dictionary<UI_Room_Creation_View, string> Names =
        new Dictionary<UI_Room_Creation_View, string>
        {
