...
public enum UI_Rooms_List_View
{
    container,
    header,
    rooms_scroll_view,
...
internal static class UI_Rooms_List_View_Map
{
    internal static readonly Dictionary<UI_Rooms_List_View, string> Names =
        new Dictionary<UI_Rooms_List_View, string>
        {
