...
internal static class UI_Credits_View_Map
{
    internal static readonly Dictionary<UI_Credits_View, string> Names =
        new Dictionary<UI_Credits_View, string>
        {
            { UI_Credits_View.tint, "tint" },
